            ...
            <div class="col-lg-6 d-flex justify-center align-center">
                <div class="center">
                    ...
                    <p class="col-lg-10 m-auto text">
                        <strong>Тоҷик Академия</strong> яке аз сомонаи бузургтарини дарсии Тоҷикистон мебошад. Ҳадаф аз кушодани сомоно кумак ба шахсоне аст, ки мехоҳанд дарсҳои пешрафтаин даруни ва дунёро биомузанд.
                    </p>
                </div>
            </div>
            <div class="col-lg-6">
                ...
                @for($i = 0; $i < 6; $i++)
                    <div>
                        <div class="sponsor">
                            ...
                            <span>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Assumenda,
                                blanditiis earum expedita perspiciatis repellendus voluptates. Beatae consequatur cum </span>
